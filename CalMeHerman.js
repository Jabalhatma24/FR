...
const Mfake = fs.readFileSync ('./media/Ganteng.jpeg')
const Mthumb = fs.readFileSync('./media/Ganteng.jpeg')
...
let fakeimage = fs.readFileSync("./media/Ganteng.jpeg")
...
petik = '```'
fake = '®Recode By JabalHatma'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝕾𝖎𝖑𝖆𝖍𝖐𝖆𝖓 𝕻𝖎𝖑𝖎𝖍 𝕯𝖎𝖘𝖓𝖎!","footerText": "FRxBotz","listType": "SINGLE_SELECT","sections": list}}, {})
        ...
        const mentions = (teks, memberr, id) => {
           (id == null || id == undefined || id == false) ? dha.sendMessage(from, {text: teks.trim(), jpegThumbnail: fs.readFileSync('./media/Ganteng.jpeg')}, extendedText, { sendEphemeral: true, contextInfo: { "mentionedJid": memberr } }) : dha.sendMessage(from, {text: teks.trim(), jpegThumbnail: fs.readFileSync('./media/Ganteng.jpeg')}, extendedText, { sendEphemeral: true, quoted: mek, contextInfo: { "mentionedJid": memberr } })
        }
        const sendText = (from, text) => {
           dha.sendMessage(from, text, MessageType.text)
        }
        const textImg = (teks) => {
           return dha.sendMessage(from, teks, text, {quoted: mek, thumbnail: fs.readFileSync('./media/Ganteng.jpeg')})
        }
        const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${senderr.split('@')[0]}:${senderr.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./media/jabal.jpeg')
        }}}
       const math = (teks) => {
      ...
      const hideTag = async function(from, text){
	       ...
	       dha.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/jabal.jpeg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}  
...
*Sewa bot?* Chat wa.me/6281245782858`
               ...
               imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/jabal.jpeg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/jabal.jpeg`)})).imageMessage

               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'FRxBotz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'Alan Botz' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://i.ibb.co/kynNYTh/Ganteng.jpeg'
              teksnya = `*[ PRICE LIST ]*
*Sewa Bot FRxBotz*
*1 Hari :* 2K
*1 Minggu :* 10K
...
*Chat Owner :* wa.me/6281245782858`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/Ganteng.jpeg'
...
*[Wait] Tunggu Sebentar..*`
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/Ganteng.jpeg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Ganteng.jpeg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Donasi Ya Kak ☕', imageMessage: imageMsg,
...
reply('_' + err + '_\n\n' + js)
       ...
       if (budy.includes(`@6281245782858`)) {
...
dha.sendMessage(from, {text:teks, jpegThumbnail:fs.readFileSync('./media/canss.jpeg')}, 'extendedTextMessage', {sendEphemeral:true, quoted:mek, contextInfo:{ forwardingScore:508, isForwarded:true, mentionedJid:[senderr]}})
}
	} 
